        ...
        <div class="col-md-12">
            <div class="card">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addPimpinan">
                        Tambah Pimpinan
                    </button>
                </div>
                
                <!-- Modal -->
                <div class="modal fade" id="addPimpinan" tabindex="-1" aria-labelledby="addPimpinanLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addPimpinanLabel">Tambah Pimpinan</h5>
                                    ...
                                    <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1" aria-labelledby="addJenisLayananLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('pimpinan.update', $item->id) }}" method="POST">
                                                        @method('PUT');
                                                        @csrf
                                                        <input type="hidden" id="id" name="id" value="{{ $item->id }}" />
                                                        <div class="mb-3">
